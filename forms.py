...
class ShopItemsForm(FlaskForm):
    ...
    product_picture = FileField('Product Pricture', validators=[FileRequired()])
...
class OrdersForms(FlaskForm):
    order_status = SelectField('Orders Status', choices=[('pending','pending'),('Accepted','Accepted'),
